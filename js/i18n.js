(() => {
  const STRINGS = {
    ko: {
      ...
      title_about: "Bake | 브랜드",
      meta_about_desc: "Bake 브랜드 소개",
      site_name: "Bake",
      nav_home: "홈",
      nav_brand: "브랜드",
      nav_product: "제품",
      ...
      home_hero_title_line1: "당신의 색감은",
      home_hero_title_line2: "정확하기에 아름답다.",
      home_hero_subtitle: "잃어버린 색 정보를 AI로 복원하다.",
      home_hero_desc:
    ...
    en: {
      ...
      title_about: "Bake | Brand",
      meta_about_desc: "Bake brand overview.",
      site_name: "Bake",
      nav_home: "Home",
      nav_brand: "Brand",
      nav_product: "Product",
      ...
      home_hero_title_line1: "Your color is",
      home_hero_title_line2: "beautiful because it is accurate.",
      home_hero_subtitle: "Restoring lost color information with AI.",
      home_hero_desc:
